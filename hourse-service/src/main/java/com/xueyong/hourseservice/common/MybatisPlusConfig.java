...
@Configuration
@MapperScan("com.xueyong.hourseservice.mapper")
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/hourse-service/src/main/java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/day6?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/hourse-service/src/main/resources/mapper/" /*+ pc.getModuleName()
